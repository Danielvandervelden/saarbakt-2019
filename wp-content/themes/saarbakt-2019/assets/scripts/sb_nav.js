...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _helper_HelperFunctions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./helper/HelperFunctions */ \"./source/scripts/helper/HelperFunctions.js\");\n\n\nclass SbNav {\n  constructor() {\n    this.navToggle = document.getElementById('sb-nav-toggle');\n    this.recipeToggle = document.querySelector('#sb-menu .menu-item-has-children');\n    this.backToggle = document.getElementById('sb-back-toggle');\n    this.body = document.body;\n    this.setListeners();\n  }\n\n  setListeners() {\n    this.navToggle.addEventListener(_helper_HelperFunctions__WEBPACK_IMPORTED_MODULE_0__[\"default\"].clickEvent(), function () {\n      this.body.classList.toggle('menu-open');\n    }.bind(this));\n    this.recipeToggle.addEventListener(_helper_HelperFunctions__WEBPACK_IMPORTED_MODULE_0__[\"default\"].clickEvent(), function (e) {\n      e.preventDefault();\n      this.body.classList.add('submenu-active');\n    }.bind(this));\n    this.backToggle.addEventListener(_helper_HelperFunctions__WEBPACK_IMPORTED_MODULE_0__[\"default\"].clickEvent(), function (e) {\n      e.preventDefault();\n      this.body.classList.remove('submenu-active');\n    }.bind(this));\n  }\n\n}\n\nconst InitNavigation = new SbNav();//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./source/scripts/sb_nav.js\n");
