...
function saarbakt_theme_files() {
	...
	wp_enqueue_script( 'saarbakt_nav', get_template_directory_uri() . '/assets/scripts/sb_nav.js', array(), NULL, true );
	wp_enqueue_script( 'saarbakt_search', get_template_directory_uri() . '/assets/scripts/sb_search.js', array(), NULL, true );
