...
function saarbakt_features() {
  ...
  add_image_size('thumbnailimage', 150, 0, false);
add_image_size('header_mobile', 768, 0, false);
add_image_size('header_full', 1500, 0, false);
add_image_size('image_mobile', 500, 0, true);
